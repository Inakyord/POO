...
/**
 * Clase que hereda de JPanel y despliega en ella la interfaz del menú de todos los juegos.
 * @author Equipo 2
 */
public class PanelJuegosCompletos extends JPanel implements PanelStandard{
    
    private Image background;
    private Deteccion detector;
    
    /**
     * Constrctor único de la clase PanelJuegosCompletos, crea una instancia nueva de la clase.
     * @param detector la instancia de ActionListener que "escucha" la activación de los componentes (botones).
     */
    public PanelJuegosCompletos(Deteccion detector) {
        initComponents();
    ...
    public void setBackground(){
        ...
        this.background = new ImageIcon(getClass().getResource("/Imagenes/JuegosCompletos.png")).getImage();
        repaint();
    }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        detector.setOpcion(3); // Poker
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // TODO add your handling code here:
        detector.setOpcion(4); // Tragamonedas
